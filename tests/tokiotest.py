...
SAMPLE_GLOBUSLOGS_START = "2019-01-29T08:00:00"
SAMPLE_GLOBUSLOGS_END = "2019-01-29T08:05:00"
SAMPLE_GLOBUSLOGS_ERR = os.path.join(INPUT_DIR, "globuslogs_error.json.gz")
