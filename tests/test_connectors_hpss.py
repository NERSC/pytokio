...
def test_find_columns():
    ...
    for test_str in TEST_STRINGS:
        cols = tokio.connectors.hpss._find_columns(test_str)
...
def test_find_columns_strict():
    ...
    for test_str in TEST_STRINGS:
        cols = tokio.connectors.hpss._find_columns(test_str, strict=True)
...
Total               64   178279.2     29685   138738.0     21860    39541.2      7825        0.0         0"""
    records = tokio.connectors.hpss._parse_section(TEST_INPUT.splitlines())
